...
castle_voice_map = {
    "gameover": [
        "castle_gameover_00.mp3",
        "castle_gameover_01.mp3",
        "castle_exp.mp3",      # 経験値(数字問わず)
        "castle_gameover_02.mp3",
    ],
    "default": [
        "castle_default_00.mp3",
        "castle_default_01.mp3",
        "castle_exp.mp3",      # 経験値(数字問わず)
        "castle_default_02.mp3",
    ],
    "max_level": "castle_max.mp3", # レベル最大時の特別音声
}
