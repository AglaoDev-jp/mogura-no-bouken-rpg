...
script = [
    ...
    "王様は、地底のもぐらたちがどれほど器用で、どれほど逞しく生きているかをよく知っていました。",
    "そんなある日、地底でいちばんヒマそうな（？）もぐらが、王様に呼び出されます。",
    "もぐら：「こんちわ王様。なんすか？用事って」",
    "王様：「まもなく、この国に伝説の勇者が現れるそうじゃ。その勇者は、“ひかりのたま”を手に入れるために、この地のダンジョンを訪れることになっておる。」",
    "王様：「しかし、そのダンジョンは――地底深く、複雑な迷路となっておる！人間ではとても進めぬ場所も多い。」",
    "王様：「……そこで――だ。もぐらよ、おぬしの出番じゃ！ダンジョンの奥底、誰よりも掘るのが得意な“もぐら”なら、きっと“ひかりのたま”を見つけ出せよう。」",
    "王様：「勇者が来る前に、こっそり取ってきてはくれぬか？」",
    "もぐら：「なんすかその“ひかりのたま”って？」",
    "王様：「ふむ、よい質問じゃ。“ひかりのたま”とは、遥か昔、魔王が現れたとき大地の精霊が封じのために生み出した伝説の宝玉。」",
