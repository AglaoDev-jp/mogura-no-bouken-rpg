...
state = {
    "text_index": 0,
    "in_dialog": True,
    "bg_images": None,  # 背景画像（必要に応じて）初回はNone
}
...
bg_files = [
    ...
    "boss_f_bg3.png",
    "boss_f_bg4.png",
    "boss_f_bg4.png",  # ボスアップ
    # 必要に応じて追加
]

# ◆イベントで表示する会話内容（boss_event_kに合わせ、話者ラベル記法へ）
script = [
    "もぐら：「やあ、しゅごもぐらくん。……そっか“ひかりのたま”って君が守護してるんだね。」",
    "しゅごもぐら：「もぐらくんじゃないか。こんなところまでどうしたんだ。」",
    "しゅごもぐら：「ここは”ひかりのたま”の祭壇。勇者様の試練の場なんだぞ。きちゃダメなんだぞ。」",
    "もぐら：「なんかさー、王様が勇者にいい顔したいみたいで、ひかりのたま代わりに取りに行けとか言われちゃってさー。」",
    "しゅごもぐら：「な、なんだと！？聖なる”ひかりのたま”をもぐらくんに！？なんとばちあたりな！」",
    "もぐら：「まあ、なんだ、これも効率化の流れじゃない？”ひかりのたま”ちょうだい。」",
